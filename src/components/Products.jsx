...
const CATALOG = {
  masamadre: {
    ...
    items: [
      ...
      { id: 'hogaza-jalapeno',   name: 'Hogaza Jalapeño con Cheddar', price: 160, category: 'Pan de Masa Madre', note: 'Jalapeño fresco y cheddar' },
      { id: 'pan-caja-vegano',   name: 'Pan de Caja Vegano',          price: 70,  category: 'Pan de Masa Madre', note: 'Molde suave y libre de ingredientes de origen animal' },
